...
const fadeLeft  = { hidden: { opacity: 0, x: -60 }, visible: { opacity: 1, x: 0, transition: { duration: 0.65, ease: [0.16, 1, 0.3, 1] } } };
const fadeRight = { hidden: { opacity: 0, x: 60 },  visible: { opacity: 1, x: 0, transition: { duration: 0.65, ease: [0.16, 1, 0.3, 1] } } };
...
export default function HomePage() {
  return (
    <>
      {/* ════════════════════════════════════════════
          HERO — Full viewport, full width like navbar
      ════════════════════════════════════════════ */}
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-24 lg:pt-32 lg:pb-28">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            >
              ...
              {/* Headline — very large, full-width */}
              <motion.h1
                variants={fadeUp}
                style={{
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap gap-3 mb-10">
                <Link
                  ...
                  style={{
                    ...
                    fontSize: '0.95rem',
                    padding: '14px 32px',
                    boxShadow: '0 0 0 0 rgba(225,29,29,0)',
            ...
            {/* ── Right: Stats column — spans 4 columns ── */}
            <motion.div
              initial="hidden"
              animate="visible"
              variants={stagger}
            ...
            >
              ...
              >
                ...
                <div style={{ fontFamily: 'Oswald, sans-serif', fontSize: '2.8rem', fontWeight: 800, color: RED }}>
                  5.0
                </div>
              </motion.div>
            </motion.div>
          ...
          >
            {features.map((f, i) => (
              ...
              >
                {/* Number watermark */}
                <div
                  className="absolute top-4 right-5 font-black pointer-events-none select-none"
                ...
                <h3 className="font-bold text-white text-lg mb-2" style={{ fontFamily: 'Oswald, sans-serif', letterSpacing: '0.03em' }}>
                  {f.title}
                </h3>
            ...
            {services.map((s) => (
              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ height: '200px' }}>
                  ...
                  <h3
                    className="absolute bottom-3 left-4 font-bold text-white"
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <Link
                    ...
                    style={{ color: RED, transition: 'gap 0.2s ease' }}
